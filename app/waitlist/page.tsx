...
export default function WaitlistPage() {
  return (
    <main className="site-shell">
      <nav className="nav">
        <a className="brand" href="/waitlist">
      ...
      <section className="template-section" id="direction">
        <div className="section-heading">
          ...
          <h2>The waitlist can move to the official domain when launch marketing starts.</h2>
          <p>
            For now, this route keeps the waitlist available while the Vercel
            project root is used to review the CRM build. Later, the production
            domain can point here while the app remains on its own route.
          </p>
        </div>
